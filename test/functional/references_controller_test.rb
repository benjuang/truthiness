...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { description: @reference.description, issue_id: @reference.issue_id, link_title: @reference.link_title, link_url: @reference.link_url }
    end
  ...
  test "should update reference" do
    put :update, id: @reference, reference: { description: @reference.description, issue_id: @reference.issue_id, link_title: @reference.link_title, link_url: @reference.link_url }
    assert_redirected_to reference_path(assigns(:reference))
  end
